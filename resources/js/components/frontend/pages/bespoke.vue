...
<div class="row justify-content-center">
    ...
    <div class="col-lg-6">
        <div class="pattern_content">
            <h5>The pattern of your shirt will depend on the style and fit you’re looking for and whether it’s made-to-measure or bespoke.
            </h5>
            <p>If you’re looking for a made-to-measure shirt, you might already have a specific style in mind and this can be discussed with your tailor at your initial consultation. Your tailor will then be able to show you the styles they have on offer and advise you on the best cut options for your shape, size and needs. Don’t worry if you have no idea what you’re looking for, a good tailor should be able to help with that too.

                When it comes to made-to-measure shirts, you will choose from a pre-set or standard pattern that is created for an average person of a particular size. However, you might find that these patterns are not quite right for you so a made-to-measure service gives you the freedom to adjust the shirt and pattern to meet your specific requirements and measurements. This might be sleeve length, shirt length or collar size.</p>
            </div>
        </div>  
 </div>
 <!-- 2nd row start -->
...
<!-- besboke pattern start -->

<section>
<div class="container">
<div class="row">
    <div class="besboke_work">
